...
const BRANDS = [
  { id:'munich', name:'Munich', icon:'⭐', color:'#e94560', desc:'Chống thấm & Sơn công nghiệp - Phân phối chính thức', count:46 },
  { id:'nano', name:'Nano House', icon:'🏡', color:'#0fb9b1', desc:'Sơn & Chống thấm công nghệ Nano - Phân phối chính thức', count:44 },
  { id:'sika', name:'Sika', icon:'🧪', color:'#6c5ce7', desc:'Vữa kỹ thuật & Chống thấm', count:77 },
  { id:'dulux', name:'Dulux', icon:'🎨', color:'#0984e3', desc:'Sơn nội thất & ngoại thất', count:81 },
  ...
  dulux: {
    "🛡️ Ngoại thất siêu cao cấp": {
      ...
      "Weathershield Powerflexx": [
        { code:'WS-Powerflexx', name:'Weathershield Powerflexx - Màng co giãn gấp 6 lần', spec:'1L / 5L / 18L', desc:'Màng sơn co giãn gấp 6 lần, chống rạn nứt, chống thấm vượt trội, chống kiềm hóa, chống phai màu, chống rêu mốc.', dm:'Theo hướng dẫn' },
      ],
    },
    "🛡️ Ngoại thất cao cấp": {
      "Weathershield": [
        { code:'WS-CaoCap', name:'Weathershield - Chống phai màu, chống thấm', spec:'1L / 5L / 15L', desc:'Chống phai màu vượt trội. Chống kiềm hóa, chống thấm, chống bám bẩn, chống rêu mốc.', dm:'Theo hướng dẫn' },
      ],
      "Weathershield Colour": [
        { code:'WS-Colour', name:'Weathershield Colour Protect - Chống phai màu vượt trội', spec:'5L / 15L / 18L', desc:'Chống phai màu vượt trội. Chống kiềm hóa, chống thấm, chống bám bẩn, chống rêu mốc. Bề mặt mờ.', dm:'Theo hướng dẫn' },
      ],
      "Inspire Ngoại thất": [
    ...
    "🧱 Sơn lót nội thất": [
      ...
      { code:'AM-Primer', name:'Ambiance Primer - Lót nội thất cao cấp', spec:'5L / 15L', desc:'Tương thích dòng Ambiance. Bám dính cao, che phủ cao, tăng độ láng mịn.', dm:'Theo hướng dẫn' },
      ...
      { code:'EC-LotPhu', name:'EasyClean Kết hợp Lót & Phủ', spec:'1L / 5L / 15L', desc:'Kết hợp Lót & Phủ - nhanh chóng và tiện lợi. Dễ lau chùi, dễ thi công, độ che lấp cao. Phù hợp trần & tường.', dm:'Theo hướng dẫn' },
    ],
    "🧱 Sơn lót ngoại thất": [
      { code:'WS-PowerSealer', name:'Weathershield PowerSealer - Sơn lót ngoại thất', spec:'5L / 18L', desc:'Tạo độ bám dính hoàn hảo, chống kiềm hóa hiệu quả. Tăng cường chống phai màu. Kết nối với sơn phủ siêu co giãn Powerflexx.', dm:'Theo hướng dẫn' },
      { code:'WS-ChongKiem', name:'Weathershield Chống kiềm - Lót ngoại thất', spec:'18L', desc:'Chống kiềm hóa (loang màu) hiệu quả. Tăng độ bền màu cho lớp sơn phủ, tạo độ bám dính cao.', dm:'Theo hướng dẫn' },
    ],
    "💧 Chống thấm Dulux": [
      ...
      { code:'Aquatech-3in1', name:'Aquatech 3in1 - Chống thấm đa năng', spec:'6kg / 20kg', desc:'Chống loang màu do kiềm hóa. Che phủ vết nứt. Màng sáng đẹp, đều màu. Không cần pha xi măng, không pha sơn lót.', dm:'Theo hướng dẫn' },
    ],
    "🧱 Bột trét Dulux": [
      { code:'Botret-IN-EX', name:'Bột trét Nội & Ngoại thất', spec:'20kg / 40kg', desc:'Tạo bề mặt láng mịn, độ bám dính cao.', dm:'Theo hướng dẫn' },
      { code:'Botret-IN', name:'Bột trét Nội thất', spec:'20kg / 40kg', desc:'Tạo bề mặt láng mịn, độ bám dính cao, dễ thi công.', dm:'Theo hướng dẫn' },
    ],
    "🎨 Nội thất bổ sung": [
      { code:'AM-PearlGlow', name:'Ambiance 5in1 Pearl Glow - Bóng Mờ', spec:'1L / 5L / 18L', desc:'Pure Air Technology: thanh lọc không khí. HD Colour Technology cho màu sắc chân thật. Bề mặt siêu láng mịn. Lau chùi vượt trội, kháng khuẩn & nấm mốc.', dm:'Theo hướng dẫn' },
      { code:'AM-AirFresh', name:'Ambiance AirFresh - Bóng', spec:'1L / 5L / 15L', desc:'Kháng virus & vi khuẩn. Chủ động chống bám bẩn. Bề mặt láng mịn, ngăn ngừa nấm mốc.', dm:'Theo hướng dẫn' },
      { code:'AM-Mo', name:'Ambiance Mờ - Kinh tế', spec:'1L / 5L', desc:'Sơn nội thất mờ chất lượng, giá hợp lý. Phù hợp cho mọi không gian.', dm:'Theo hướng dẫn' },
    ],
    "🪵 Gỗ & Kim loại": [
      { code:'SonDau-Maxilite', name:'Sơn Dầu Maxilite cho Gỗ & Kim Loại', spec:'0.75L / 2.5L / 15L', desc:'Bề mặt bóng mịn, nhanh khô, độ phủ cao. Hơn 1.000 màu. Không chì, không thủy ngân.', dm:'Theo hướng dẫn' },
      { code:'Lot-ChongRi', name:'Sơn lót ngăn ngừa rỉ sét Maxilite', spec:'0.8L / 3L / 15L', desc:'Ngăn ngừa rỉ sét cho kim loại sắt thép. Tạo bám dính cho lớp hoàn thiện. Không chì, không thủy ngân.', dm:'Theo hướng dẫn' },
    ],
  },
  maxilite: {
    "🎨 Ngoại thất": {
      "Tough": [
        { code:'MX-Tough-Mo', name:'Maxilite Tough - Bề mặt Mờ', spec:'8L / 15L', desc:'Chống bong tróc hiệu quả, màu đẹp lâu phai. Độ phủ cao, chống rêu mốc. Công nghệ Super Lock.', dm:'Theo hướng dẫn' },
        { code:'MX-Tough-BongMo', name:'Maxilite Tough - Bề mặt Bóng Mờ', spec:'5L / 18L', desc:'Chống bong tróc hiệu quả, màu đẹp lâu phai. Độ phủ cao, bề mặt bóng mờ sang trọng.', dm:'Theo hướng dẫn' },
      ],
      "Total": [
        { code:'MX-Total-Mo', name:'Maxilite Total - Bề mặt Mờ', spec:'5L / 15L', desc:'Chống bong tróc hiệu quả, màu đẹp lâu phai. Độ phủ cao, bề mặt láng mịn. Công nghệ Super Lock.', dm:'Theo hướng dẫn' },
        { code:'MX-Total-BongMo', name:'Maxilite Total - Bề mặt Bóng Mờ', spec:'5L / 18L', desc:'Chống bong tróc hiệu quả. Độ phủ cao, bề mặt láng mịn. Công nghệ Super Lock tiên tiến.', dm:'Theo hướng dẫn' },
      ],
      "Che Phủ Hiệu Quả": [
        { code:'MX-ChePhu', name:'Maxilite Che Phủ Hiệu Quả', spec:'5L / 15L', desc:'Độ phủ cao, độ che lấp cao. Màng sơn đẹp & nhẵn mịn. Công nghệ Super Lock.', dm:'Theo hướng dẫn' },
      ],
      "Smooth": [
        { code:'MX-Smooth', name:'Maxilite Smooth', spec:'5L / 18L', desc:'Chất lượng tốt với giá kinh tế. Màu sắc đẹp & tươi sáng.', dm:'Theo hướng dẫn' },
      ],
    },
    "🧱 Sơn lót & Bột trét": {
      "Sơn lót Ngoại thất": [
        { code:'MX-Lot-NgoaiThat', name:'Maxilite Sơn lót Ngoại thất', spec:'8L / 18L', desc:'Bảo vệ tường không bị loang màu, tăng khả năng chống kiềm. Tăng độ bền cho lớp sơn phủ.', dm:'Theo hướng dẫn' },
      ],
      "Sơn lót Nội thất": [
        { code:'MX-Lot-NoiThat', name:'Maxilite Sơn lót Nội thất', spec:'5L / 18L', desc:'Tạo độ bám dính tốt, tăng độ bền cho lớp sơn phủ. Dễ thi công.', dm:'Theo hướng dẫn' },
      ],
      "Bột trét": [
        { code:'MX-Botret', name:'Maxilite Bột trét Nội & Ngoại thất', spec:'20kg / 40kg', desc:'Tạo bề mặt láng mịn. Độ bám dính cao. Dễ thi công.', dm:'Theo hướng dẫn' },
      ],
    },
    "🪵 Gỗ & Kim loại": [
      { code:'MX-SonDau', name:'Maxilite Sơn dầu cho Gỗ & Kim loại', spec:'0.75L / 2.5L / 15L', desc:'Màu sắc đa dạng hơn 1.000 màu. Áp dụng hơn 200 màu RAL K7. Bề mặt bóng mịn, nhanh khô, độ phủ cao.', dm:'Theo hướng dẫn' },
      { code:'MX-Lot-ChongRi', name:'Maxilite Sơn lót ngăn ngừa rỉ sét', spec:'0.8L / 3L / 15L / 18L', desc:'Ngăn ngừa rỉ sét cho kim loại sắt thép. Tạo độ bám dính cho lớp hoàn thiện. Không chì, không thủy ngân.', dm:'Theo hướng dẫn' },
    ],
  },
  jotun: {
    "🎨 Sơn nội thất": {
...
const PRICE_MAP = {
  ...
  maxilite: {
    // Maxilite từ Dulux (bảng giá 13/03/2026)
    ...
    'MX-Botret':                { price:'385.000đ', spec:'40kg' },
    'MX-SonDau':                { price:'505.000đ', spec:'2.5L' },
    'MX-Lot-ChongRi':           { price:'414.000đ', spec:'3L' },
  },
  jotun: {
...
const PRICES = [
  ...
  // --- DULUX (bảng giá 13/03/2026 từ PDF) ---
  ...
  { brand:'Dulux', product:'Weathershield Powerflexx', spec:'1L', price:'570.000đ' },
  { brand:'Dulux', product:'Weathershield Powerflexx', spec:'5L', price:'2.580.000đ' },
  { brand:'Dulux', product:'Weathershield Powerflexx', spec:'18L', price:'7.350.000đ' },
  { brand:'Dulux', product:'Weathershield Cao cấp', spec:'1L', price:'454.000đ' },
  { brand:'Dulux', product:'Weathershield Cao cấp', spec:'5L', price:'2.045.000đ' },
  { brand:'Dulux', product:'Weathershield Cao cấp', spec:'15L', price:'5.828.000đ' },
  { brand:'Dulux', product:'Weathershield Colour Protect Mờ', spec:'5L', price:'1.500.000đ' },
  { brand:'Dulux', product:'Weathershield Colour Protect Mờ', spec:'15L', price:'4.300.000đ' },
  { brand:'Dulux', product:'Weathershield Colour Protect Mờ', spec:'18L', price:'5.145.000đ' },
  ...
  { brand:'Dulux', product:'Inspire Ngoại thất Mờ', spec:'18L', price:'4.518.000đ' },
  ...
  { brand:'Dulux', product:'Ambiance 5in1 Diamond Glow', spec:'5L', price:'2.012.000đ' },
  { brand:'Dulux', product:'Ambiance 5in1 Pearl Glow Bóng Mờ', spec:'5L', price:'2.053.000đ' },
  { brand:'Dulux', product:'Ambiance AirFresh Bóng', spec:'5L', price:'1.236.000đ' },
  { brand:'Dulux', product:'Ambiance Mờ', spec:'5L', price:'1.180.000đ' },
  { brand:'Dulux', product:'EasyClean Chống Bám Bẩn KV Bóng', spec:'5L', price:'1.236.000đ' },
  ...
  { brand:'Dulux', product:'EasyClean Lót & Phủ', spec:'5L', price:'810.000đ' },
  { brand:'Dulux', product:'Weathershield PowerSealer Chống kiềm', spec:'5L', price:'1.355.000đ' },
  { brand:'Dulux', product:'Weathershield PowerSealer Chống kiềm', spec:'18L', price:'4.680.000đ' },
  { brand:'Dulux', product:'Weathershield PowerSealer', spec:'5L', price:'1.230.000đ' },
  { brand:'Dulux', product:'Weathershield Chống kiềm', spec:'18L', price:'4.250.000đ' },
  ...
  { brand:'Dulux', product:'Ambiance Primer Lót nội thất', spec:'15L', price:'2.482.000đ' },
  { brand:'Dulux', product:'Interior Primer Lót nội thất', spec:'5L', price:'869.000đ' },
  { brand:'Dulux', product:'Interior Primer Lót nội thất', spec:'18L', price:'2.979.000đ' },
  { brand:'Dulux', product:'EasyClean Primer Lót nội thất', spec:'5L', price:'783.000đ' },
  { brand:'Dulux', product:'EasyClean Primer Lót nội thất', spec:'15L', price:'2.234.000đ' },
  ...
  { brand:'Dulux', product:'Aquatech 3in1 Chống thấm', spec:'6kg', price:'936.000đ' },
  { brand:'Dulux', product:'Aquatech 3in1 Chống thấm', spec:'20kg', price:'3.060.000đ' },
  ...
  { brand:'Dulux', product:'Bột trét Nội & Ngoại thất', spec:'20kg', price:'358.000đ' },
  { brand:'Dulux', product:'Bột trét Nội & Ngoại thất', spec:'40kg', price:'666.000đ' },
  { brand:'Dulux', product:'Bột trét Nội thất', spec:'20kg', price:'268.000đ' },
  { brand:'Dulux', product:'Bột trét Nội thất', spec:'40kg', price:'493.500đ' },
  // --- MAXILITE (từ Dulux, bảng giá 13/03/2026) ---
  { brand:'Maxilite', product:'Tough Bề mặt Mờ', spec:'8L', price:'749.000đ' },
  { brand:'Maxilite', product:'Tough Bề mặt Mờ', spec:'15L', price:'2.013.000đ' },
  { brand:'Maxilite', product:'Tough Bề mặt Bóng Mờ', spec:'5L', price:'828.000đ' },
  { brand:'Maxilite', product:'Tough Bề mặt Bóng Mờ', spec:'18L', price:'2.216.000đ' },
  { brand:'Maxilite', product:'Total Bề mặt Mờ', spec:'5L', price:'549.000đ' },
  { brand:'Maxilite', product:'Total Bề mặt Mờ', spec:'15L', price:'1.460.000đ' },
  { brand:'Maxilite', product:'Total Bề mặt Bóng Mờ', spec:'5L', price:'629.000đ' },
  { brand:'Maxilite', product:'Total Bề mặt Bóng Mờ', spec:'18L', price:'1.638.000đ' },
  { brand:'Maxilite', product:'Che Phủ Hiệu Quả', spec:'5L', price:'360.000đ' },
  { brand:'Maxilite', product:'Che Phủ Hiệu Quả', spec:'15L', price:'1.007.000đ' },
  { brand:'Maxilite', product:'Smooth', spec:'5L', price:'269.000đ' },
  { brand:'Maxilite', product:'Smooth', spec:'18L', price:'917.000đ' },
  { brand:'Maxilite', product:'Sơn lót Ngoại thất', spec:'8L', price:'757.000đ' },
  { brand:'Maxilite', product:'Sơn lót Ngoại thất', spec:'18L', price:'2.072.000đ' },
  { brand:'Maxilite', product:'Sơn lót Ngoại thất', spec:'18L', price:'2.437.000đ' },
  { brand:'Maxilite', product:'Sơn lót Nội thất', spec:'5L', price:'460.000đ' },
  { brand:'Maxilite', product:'Sơn lót Nội thất', spec:'18L', price:'1.518.000đ' },
  { brand:'Maxilite', product:'Bột trét Nội & Ngoại thất', spec:'20kg', price:'210.000đ' },
  { brand:'Maxilite', product:'Bột trét Nội & Ngoại thất', spec:'40kg', price:'385.000đ' },
  { brand:'Maxilite', product:'Sơn dầu Gỗ & Kim loại', spec:'0.75L', price:'160.000đ' },
  { brand:'Maxilite', product:'Sơn dầu Gỗ & Kim loại', spec:'2.5L', price:'505.000đ' },
  { brand:'Maxilite', product:'Sơn dầu Gỗ & Kim loại', spec:'15L', price:'2.717.000đ' },
  { brand:'Maxilite', product:'Lót ngăn ngừa rỉ sét', spec:'0.8L', price:'123.000đ' },
  { brand:'Maxilite', product:'Lót ngăn ngừa rỉ sét', spec:'3L', price:'414.000đ' },
  { brand:'Maxilite', product:'Lót ngăn ngừa rỉ sét', spec:'15L', price:'1.997.000đ' },
  { brand:'Maxilite', product:'Lót ngăn ngừa rỉ sét', spec:'18L', price:'2.397.000đ' },
  // --- SIKA (bảng giá OCR) ---
