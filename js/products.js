...
const PRODUCTS = {
  munich: {
    ...
    "🛡️ Sơn chống thấm": [
      { code:'G20', name:'Màng chống thấm đàn hồi 200% (xi măng-polymer)', spec:'Bộ 26kg', desc:'Chống thấm hai thành phần xi măng-polymer siêu đàn hồi. Dùng cho tầng hầm, sàn mái, bể nước, nhà vệ sinh, ban công.', dm:'0,6 kg/m², 2-3 lớp' },
      { code:'G20S', name:'Màng chống thấm đàn hồi 200%', spec:'Bộ 25kg', desc:'Giống G20, quy cách đóng gói khác.', dm:'0,6 kg/m², 2-3 lớp' },
      { code:'G20C', name:'Siêu cứng, siêu bám dính, hiệu ứng lá sen', spec:'Bộ 20kg', desc:'Chống thấm cao cấp hiệu ứng lá sen. Chống bám bụi, dễ vệ sinh.', dm:'0,6-1 kg/m²/lớp, 8 m²/4 lớp' },
      ...
      { code:'CT0', name:'Acrylic chống thấm pha xi măng', spec:'Lon 5kg / Thùng 18kg', desc:'Chống thấm acrylic cho sàn mái, ban công, tường ngoài.', dm:'1kg + 0,5kg xi măng + 0,3kg nước' },
      { code:'PU S700', name:'Chống thấm PU một thành phần - đàn hồi 700% (gốc nước)', spec:'Lon 1L/4L / Thùng 18L', desc:'Chống thấm lộ thiên, chịu UV. Hơn 1.000 màu sắc.', dm:'0,75 kg/m²/lớp, ~6 m²/lớp' },
      { code:'PU S400', name:'Chống thấm PU một thành phần - đàn hồi 400% (gốc nước)', spec:'Lon 5L / Thùng 18L', desc:'Giống S700, độ đàn hồi thấp hơn, giá thành hợp lý hơn.', dm:'~6 m²/lớp' },
      { code:'PU S800F', name:'Chống thấm PU hai thành phần - đàn hồi 700% (gốc dầu)', spec:'Bộ 3,6kg/18kg', desc:'Chống thấm lộ thiên, cần lót EP11 trước khi thi công.', dm:'1 kg/m²' },
