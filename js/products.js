...
// GIÁ TỪ DATABASE_SANPHAM.JSON (USB VLHT)
const PRICE_MAP = {
  munich: {
    ...
    'EP11 Lót':               { price:'4.050.000đ', spec:'Bộ 15kg' },
    'EP11 Phủ':               { price:'4.050.000đ', spec:'Bộ 15kg' },
    'S632':                   { price:'1.328.001đ', spec:'Lon 5kg' },
  },
  jotun: {
    'JS-BenMauToiUu':     { price:'2.440.000đ', spec:'5L' },
    'MJ-HoanHao-Bong5':   { price:'1.815.000đ', spec:'5L' },
    'MJ-HoanHao-Mo':      { price:'1.815.000đ', spec:'5L' },
    'MJ-NguyenBan':       { price:'1.815.000đ', spec:'5L' },
    'ES-ChePhu-Bong':     { price:'1.215.000đ', spec:'5L' },
...
function getPrice(bid, code) {
  ...
  if (!pm) return null;
  // Try exact match first, then check if code starts with any key
...
const PRICES = [
  // --- MUNICH ---
  { brand:'Munich', product:'Munich Luxury Siêu bóng Nội thất', spec:'5L', price:'983.333đ' },
  { brand:'Munich', product:'Munich Luxury Siêu bóng Nội thất', spec:'18L', price:'2.950.000đ' },
  { brand:'Munich', product:'Munich Luxury Siêu bóng Ngoại thất', spec:'5L', price:'1.266.667đ' },
  { brand:'Munich', product:'Munich Luxury Siêu bóng Ngoại thất', spec:'18L', price:'3.800.000đ' },
  { brand:'Munich', product:'Munich Action Siêu mịn Nội thất', spec:'5L', price:'466.667đ' },
  { brand:'Munich', product:'Munich Action Siêu mịn Nội thất', spec:'18L', price:'1.400.000đ' },
  { brand:'Munich', product:'Munich Action Siêu mịn Ngoại thất', spec:'5L', price:'633.333đ' },
  { brand:'Munich', product:'Munich Action Siêu mịn Ngoại thất', spec:'18L', price:'1.900.000đ' },
  { brand:'Munich', product:'Munich Economy Kinh tế', spec:'5L', price:'190.000đ' },
  { brand:'Munich', product:'Munich Economy Kinh tế', spec:'18L', price:'592.500đ' },
  { brand:'Munich', product:'Munich FLY Bóng mờ Nội thất', spec:'5L', price:'780.000đ' },
  { brand:'Munich', product:'Munich FLY Bóng mờ Nội thất', spec:'18L', price:'2.000.000đ' },
  { brand:'Munich', product:'Munich Nano AB Diệt khuẩn Siêu bóng', spec:'5L', price:'2.943.333đ' },
  { brand:'Munich', product:'Munich Nano AB Diệt khuẩn Siêu bóng', spec:'18L', price:'8.830.000đ' },
  { brand:'Munich', product:'Munich UV20 Chống nóng', spec:'4L', price:'1.200.000đ' },
  { brand:'Munich', product:'Munich UV20 Chống nóng', spec:'18L', price:'6.225.000đ' },
  { brand:'Munich', product:'Munich Epoxy EP11 Sơn sàn', spec:'15kg', price:'4.050.000đ' },
  { brand:'Munich', product:'Munich Sport C631 Sân thể thao', spec:'5kg', price:'1.328.001đ' },
  { brand:'Munich', product:'Munich Sport C631 Sân thể thao', spec:'18kg', price:'3.570.000đ' },
  // --- JOTUN ---
  { brand:'Jotun', product:'Jotashield Bền màu tối ưu', spec:'5L', price:'2.440.000đ' },
  { brand:'Jotun', product:'Jotashield Bền màu tối ưu', spec:'15L', price:'7.250.000đ' },
  ...
  { brand:'Jotun', product:'Essence Che phủ tối đa', spec:'5L', price:'1.215.000đ' },
  { brand:'Jotun', product:'Essence Che phủ tối đa', spec:'17L', price:'3.720.000đ' },
  { brand:'Jotun', product:'WaterGuard Chống thấm', spec:'5L', price:'1.060.000đ' },
  { brand:'Jotun', product:'WaterGuard Chống thấm', spec:'17L', price:'3.340.000đ' },
  // --- NANO HOUSE ---
  ...
  { brand:'Nano House', product:'Eco Proguard Chống thấm', spec:'5L', price:'1.340.000đ' },
  { brand:'Nano House', product:'Eco Proguard Chống thấm', spec:'18L', price:'4.428.000đ' },
  // --- KOVA ---
