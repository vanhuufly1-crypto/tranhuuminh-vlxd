...
function card(p, brand) {
  ...
  const contactBtns = `<div class="prod-actions">
    <a href="#" onclick="if(window.THM_Chat){THM_Chat.navigate('bao-gia');THM_Chat.open();}return false;" class="pa-btn pa-quote" title="Báo giá">📋 Báo giá (Mây)</a>
    <a href="tel:0378679633" class="pa-btn pa-call" title="Gọi">📞 Gọi (Anh Hữu)</a>
  </div>`;
